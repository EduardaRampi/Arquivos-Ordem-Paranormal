...
* **CSS3:** Estilização (Flexbox, Grid, Variáveis, Design Responsivo).
* **JavaScript (Vanilla):** Lógica de navegação entre telas e manipulação de DOM.
* **JSON:** Armazenamento e organização dos dados de jogo.
